...
// import '../../pruebas/new_equip_hospitalizacion_controller.dart';
...
class newEquipHospitalizacion extends StatefulWidget {
  @override
  State<newEquipHospitalizacion> createState() =>
      _newEquipHospitalizacionState();
}

class _newEquipHospitalizacionState extends State<newEquipHospitalizacion> {
  ...
  // final EquipoHospitalizacionViewModel _equipoHospitalizacionViewModel =
  //     EquipoHospitalizacionViewModel();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbarInterfacesWidget(
          nameAppbar: 'Nuevo Equipo - Hospitalizacion',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ButtonRegisterEquipoWidget(
                    option1: 'monitor multiparametro',
                    option2: 'mezclador de gases',
                    option3: 'oximetro de pulso de mesa',
                    option4: 'bomba de nutricion enteral',
