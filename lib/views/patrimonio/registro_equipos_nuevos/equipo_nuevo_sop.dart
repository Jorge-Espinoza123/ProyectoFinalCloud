...
// import 'package:hospital/viewmodels/new_equip_sop_controller.dart';
...
class newEquipSop extends StatefulWidget {
  @override
  State<newEquipSop> createState() => _newEquipSopState();
}

class _newEquipSopState extends State<newEquipSop> {
  ...
  // final EquipoSopViewModel _equipoSopViewModel = EquipoSopViewModel();
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ButtonRegisterEquipoWidget(
                    option1: 'lampara cielitica',
                    option2: 'equipo de anestesia',
                    option3: 'cuna radiante',
                    option4: 'electrocauterio',
