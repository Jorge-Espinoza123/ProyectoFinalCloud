...
// import '../../pruebas/new_equip_emergencia_controller.dart';
...
class newEquipEmergencia extends StatefulWidget {
  @override
  State<newEquipEmergencia> createState() => _newEquipEmergenciaState();
}

class _newEquipEmergenciaState extends State<newEquipEmergencia> {
  ...
  // final EquipoEmergenciaViewModel _equipoEmergenciaViewModel =
  //     EquipoEmergenciaViewModel();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbarInterfacesWidget(
          nameAppbar: 'Nuevo Equipo - Emergencia',
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ButtonRegisterEquipoWidget(
                    ...
                    option2: 'desfibrilador',
                    option3: 'ventilador mecanico portatil',
                    option4: 'oximetro de pulso portatil',
              ...
              dualOption(
                ...
                onPressedButton2: () async {
                  // String? docId = await _equipoEmergenciaViewModel
                  //     .registrarEquipo(
