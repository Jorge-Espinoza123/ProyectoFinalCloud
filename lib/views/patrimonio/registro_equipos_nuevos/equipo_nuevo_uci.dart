...
// import 'package:hospital/viewmodels/new_equip_uci_controller.dart';
...
class newEquipUci extends StatefulWidget {
  @override
  State<newEquipUci> createState() => _newEquipUciState();
}

class _newEquipUciState extends State<newEquipUci> {
  ...
  // final EquipoUciViewModel _equipoUciViewModel = EquipoUciViewModel();
