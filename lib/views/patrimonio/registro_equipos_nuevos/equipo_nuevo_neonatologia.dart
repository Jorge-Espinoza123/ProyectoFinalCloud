...
// import '../../pruebas/new_equip_neonatologia_controller.dart';
...
class newEquipNeonatologia extends StatefulWidget {
  @override
  State<newEquipNeonatologia> createState() => _newEquipNeonatologiaState();
}

class _newEquipNeonatologiaState extends State<newEquipNeonatologia> {
  ...
  // final EquipoNeonatologiaViewModel _equipoNeonatologiaViewModel =
  //     EquipoNeonatologiaViewModel();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbarInterfacesWidget(
          nameAppbar: 'Nuevo Equipo - Neonatologia',
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ButtonRegisterEquipoWidget(
                    option1: 'incubadora',
                    option2: 'aspirador de secreciones',
                    option3: 'monitor signos vitales neonatal',
                    option4: 'lampara de fototerapia',
              ...
              //       'monitor de signos vitales neonatal',
              //       'lampara de fototerapia',
              //     ],
              //     valor: _selectedDenominacion,
              //     textoFondo: 'Selecciona una opción',
              //     onChanged: (value) {
              //       setState(() {
              ...
              dualOption(
                ...
                onPressedButton2: () async {
                  // String? docId = await _equipoNeonatologiaViewModel
                  //     .registrarEquipo(
