...
import 'package:hospital/views/medicina/uci/6.10.5.equipos_area_uci_noEditReport.dart';
...
class homepageMedicinaUci extends StatelessWidget {
  @override
            ...
            children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => equiposAreaUcinoEditReport(),
                        ),
                      );
                    },
                    child: Column(
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 24),
                  ImageButton(
                    imagePath: 'assets/images/equipo_bombaInfusion.jpg',
                    text: 'Bombas de Infusion',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
