...
import 'package:hospital/views/medicina/sop/6.10.8.equipos_area_sop_noEditReport.dart';
...
class homepageMedicinaSop extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => equiposAreaSopnoEditReport(),
                        ),
                      );
                    },
                    child: Column(
              ...
              Row(
                ...
                children: [
                  ImageButton(
                    imagePath: 'assets/images/equipo_lamparaCielitica.jpg',
                    text: 'Lampara Cielitica',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  SizedBox(width: 24),
                  ImageButton(
                    imagePath: 'assets/images/equipo_equipoAnestesia.png',
                    text: 'Maquina Anestesia',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
              ...
              Row(
                ...
                children: [
                  ImageButton(
                    imagePath: 'assets/images/equipo_cunaRadiante.jpg',
                    text: 'Cuna Radiante',
                    onPressed: () {
                      Navigator.push(
                        context,
                  ...
                  SizedBox(width: 24),
                  ImageButton(
                    imagePath: 'assets/images/equipo_electrocauterio.jpg',
                    text: 'Electrocauterio',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
