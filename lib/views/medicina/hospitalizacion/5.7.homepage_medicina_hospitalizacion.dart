...
import 'package:hospital/views/medicina/hospitalizacion/6.10.7.equipos_area_hospitalizacion_noEditReport.dart';
...
class homepageMedicinaHospitalizacion extends StatelessWidget {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbarInterfacesWidget(
          nameAppbar: 'Home - Hospitalizacion',
            ...
            children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (_) => equiposAreaHospitalizacionnoEditReport(),
                        ),
                      );
                    },
                    child: Column(
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 24),
                  ImageButton(
                    imagePath: 'assets/images/equipo_mezcladorGases.jpg',
                    text: 'Mezclador de Gases',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 24),
                  ImageButton(
                    imagePath: 'assets/images/equipo_bombaNutricion.jpg',
                    text: 'Bombas de Nutricion',
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
