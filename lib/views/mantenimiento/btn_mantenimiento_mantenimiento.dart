...
import 'package:hospital/views/mantenimiento/mantenimiento_areas/mantenimiento_area_uci.dart';
import 'package:hospital/views/mantenimiento/mantenimiento_areas/mantenimiento_area_sop.dart';
import 'package:hospital/views/mantenimiento/mantenimiento_areas/mantenimiento_area_hospitalizacion.dart';
import 'package:hospital/views/mantenimiento/mantenimiento_areas/mantenimiento_area_emergencia.dart';
...
class mantenimientoArea extends StatelessWidget {
  @override
                ...
                cardWidget(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => mantenimientoAreaUci(),
                      ),
                    );
                  },
                ),
                ...
                cardWidget(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => mantenimientoAreaSop(),
                      ),
                    );
                  },
                ),
                ...
                cardWidget(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => mantenimientoAreaEmergencia(),
                      ),
                    );
                  },
                ),
                ...
                cardWidget(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => manteniminetoAreaHospitalizacion(),
                      ),
                    );
                  },
                ),
