...
class CardEquipoWidgetMantenimiento extends StatelessWidget {
  String codigo;
  String nombre;
  String anios;
  String marca;
  ...
  String ubicacion;
  String estado;
  VoidCallback registerMantenimiento;
  VoidCallback historialMantenimiento;
  // VoidCallback editIcon;
  // VoidCallback deleteIcon;

  CardEquipoWidgetMantenimiento({
    ...
    required this.registerMantenimiento,
    required this.historialMantenimiento,
